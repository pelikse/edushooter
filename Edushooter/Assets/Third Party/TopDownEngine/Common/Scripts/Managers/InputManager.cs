...
{	
	...
	public class InputManager : MMSingleton<InputManager>
	{
        ...
        /// the teleport ability button
        public MMInput.IMButton TeleportAbilityButton { get; protected set; }
		...
		protected virtual void InitializeButtons()
		{
            ...
            ButtonList.Add(TeleportAbilityButton = new MMInput.IMButton(PlayerID, "TeleportAbility", TeleportAbilityButtonDown, TeleportAbilityButtonPressed, TeleportAbilityButtonUp));
		...
		public virtual void TeleportAbilityButtonDown() { TeleportAbilityButton.State.ChangeState(MMInput.ButtonStates.ButtonDown); }
        public virtual void TeleportAbilityButtonPressed() { TeleportAbilityButton.State.ChangeState(MMInput.ButtonStates.ButtonPressed); }
        public virtual void TeleportAbilityButtonUp() { TeleportAbilityButton.State.ChangeState(MMInput.ButtonStates.ButtonUp); }
